...
public class NotIscriptionChampionshipRankActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_move_info = (Button) findViewById(R.id.btn_not_inscription_rank_to_info);
        btn_move_championship = (Button) findViewById(R.id.btn_not_inscription_rank_to_championship);
        lv_pilot = (ListView) findViewById(R.id.lv_rank_user_not_iscription_championship);
        lv_team = (ListView) findViewById(R.id.lv_rank_team_not_iscription_championship);
        ...
        btn_move_championship.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NotIscriptionChampionshipRankActivity.this, NotInscriptionChampionshipActivity.class);
                intent.putExtra("champId", champId);
                startActivity(intent);
            }
        });
    ...
    public void ClickHome(View view) {
        Intent intent = new Intent(NotIscriptionChampionshipRankActivity.this, HomeActivity.class);
        intent.putExtra("userId", userId);
        startActivity(intent);
    }

    public void ClickProfile(View view) {
        Intent intent = new Intent(NotIscriptionChampionshipRankActivity.this, ProfileActivity.class);
        startActivity(intent);
    }

    public void ClickMyChampionship(View view) {
        Intent intent = new Intent(NotIscriptionChampionshipRankActivity.this, MyChampionshipActivity.class);
        intent.putExtra("userId", userId);
        startActivity(intent);
    }

    public void ClickChampionship(View view) {
        Intent intent = new Intent(NotIscriptionChampionshipRankActivity.this, ChampionshipsActivity.class);
        intent.putExtra("userId", userId);
        startActivity(intent);
    }

    public void ClickGallery(View view) {
        Intent intent = new Intent(NotIscriptionChampionshipRankActivity.this, GalleryActivity.class);
        startActivity(intent);
    }

    public void ClickLogOut(View view) {
        db.updateStatus(Utils.STATUS_NOT_LOGGED, -1);
        Intent intent = new Intent(NotIscriptionChampionshipRankActivity.this, LoginActivity.class);
